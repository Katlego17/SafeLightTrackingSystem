...
class PostCastPhase extends Component
{
    ...
    public function changePhase()
    {
        if (!empty($this->selectedProducts)) {
            ...
            Product::whereIn('id', $this->selectedProducts)->update(['CurrentPhase' => 'assembled','DateAssembled' => $date]);
    ...
    public function render()
    {
        ...
        $postcastedLights = Product::where('CurrentPhase','=','postcasted')->paginate(10);
